...
if __name__ == "__main__":
    txt_filenames = [
        ...
        "/workspace/CUDA-CEOs/datasets/txt/yahoo/Yahoo_X_624961_300.txt",
            "/workspace/CUDA-CEOs/datasets/txt/gist/gist/_X_1000000_960.txt",
        "/workspace/CUDA-CEOs/datasets/txt/gist/gist/_Q_1000_960.txt"
    ]
    ...
    bin_filenames = [
        ...
        "/workspace/CUDA-CEOs/datasets/bin/gist/gist_dataset.bin",
        "/workspace/CUDA-CEOs/datasets/bin/gist/gist_queries.bin"
    ]
